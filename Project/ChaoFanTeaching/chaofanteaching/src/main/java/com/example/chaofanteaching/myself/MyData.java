...
//                finish();
    ...
    private void insert(String name1,String phone1,String address1,String sex,String email,String lat,String lng){
        ...
        Request request=new Request.Builder().
                url("http://81.70.134.107:8080/ChaoFanTeaching/MyData?name="+user+"&nameContent="+name1+"&phoneContent="+phone1+"&addressContent="+address1+"&sexContent="+sex+"&index=insert&email="+email+"&locate="+lat+","+lng)
                .build();
